        ...
        <div className="min-h-[70vh] flex flex-col md:flex-row md:justify-between items-center mt-16">
          <div className=" md:w-2/4 text-center">
            ...
            <p className=" text-lightText mt-5 text-start">
              Unlock Your Potential with Open Mentors: Dive into a world of
              personalized mentorship and skill-building opportunities. Our
              innovative eLearning platform connects you with top-tier engineers
              and developers for tailored one-on-one guidance.
            </p>
          ...
          <section className="hero_footer">
            <div className="hero_footer--grid">
              <div className="hero_footer--col hero_footer--left">
                <h2 className="hero_footer--heading">
                  Why Choose Open Mentors
                </h2>
                <p>
                  Embark on your journey into the vibrant world of open source
                  with us. Whether you're a seasoned developer or just starting
                  out, our platform is your gateway to endless opportunities for
                  learning, collaboration, and contribution.
                </p>
                <Link
                  to={userLogin ? '/blogs' : '/signIn'}
                  className="hero_btn"
                >
                  Get started Today
              ...
              <div className="hero_footer--col hero_footer--right">
                <div className="hero_footer--dflex">
                  <div className="hero_footer--col-row">
                    ...
                    <p>
                      ...
                      innovation, and making a positive impact on the world. By
                      joining the open source movement, you're not only honing
                      your skills but also becoming part of something bigger
                      than yourself.
                    </p>
                  </div>
                  <div className="hero_footer--col-row">
                    ...
                    <p>
                      ...
                      difference in the world of open source. Begin your journey
                      with us and witness the transformative power of
                      collaboration..
                    </p>
                  </div>
                </div>
                <div className="hero_footer--dflex">
                  <div className="hero_footer--col-row">
                    ...
                    <p>
                      Ready to dive in? Explore a multitude of projects spanning
                      various domains, each offering a unique chance to sharpen
                      your skills, build your portfolio, and connect with
                  ...
                  <div className="hero_footer--col-row">
                    ...
                    <p>
                      Explore new horizons, expand your network, and enhance
                      your career prospects by becoming an active participant in
                      the open-source ecosystem. The opportunities are
                      limitless.
                    </p>
                  </div>
                </div>
